...
class Customer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Customer', package: const $pb.PackageName(_omitMessageNames ? '' : 'customer.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..e<$1.Prefecture>(3, _omitFieldNames ? '' : 'hometown', $pb.PbFieldType.OE, defaultOrMaker: $1.Prefecture.PREFECTURE_UNKNOWN_UNSPECIFIED, valueOf: $1.Prefecture.valueOf, enumValues: $1.Prefecture.values)
  ...
  @$pb.TagNumber(3)
  $1.Prefecture get hometown => $_getN(2);
  @$pb.TagNumber(3)
  set hometown($1.Prefecture v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasHometown() => $_has(2);
  @$pb.TagNumber(3)
  void clearHometown() => clearField(3);
