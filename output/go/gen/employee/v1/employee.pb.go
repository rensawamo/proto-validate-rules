...
type Employee struct {
	...
	Hometown      v1.Prefecture          `protobuf:"varint,4,opt,name=hometown,proto3,enum=common.v1.Prefecture" json:"hometown,omitempty"`
...
func (x *Employee) GetHometown() v1.Prefecture {
	if x != nil {
		return x.Hometown
	}
...
const file_employee_v1_employee_proto_rawDesc = "" +
	"\n" +
	"\x1aemployee/v1/employee.proto\x12\vemployee.v1\x1a\x16common/v1/common.proto\"\x81\x01\n" +
	"\bEmployee\x12\x0e\n" +
	...
	"department\x121\n" +
	"\bhometown\x18\x04 \x01(\x0e2\x15.common.v1.PrefectureR\bhometownB\xbc\x01\n" +
	"\x0fcom.employee.v1B\rEmployeeProtoP\x01ZMhttps:/github.com/rensawamo/common-proto/output/go/gen/employee/v1;employeev1\xa2\x02\x03EXX\xaa\x02\vEmployee.V1\xca\x02\vEmployee\\V1\xe2\x02\x17Employee\\V1\\GPBMetadata\xea\x02\fEmployee::V1b\x06proto3"
...
var file_employee_v1_employee_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_employee_v1_employee_proto_depIdxs = []int32{
	1, // 0: employee.v1.Employee.hometown:type_name -> common.v1.Prefecture
